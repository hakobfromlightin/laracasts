    ...
    public function run()
    {
        $skills = [
            [
                ...
                'completed' => false,
                'started_at' => Carbon::create(2013, 9, 19),//temp
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                'name' => 'Laravel',
                'image' => 'images/skills/laravel.jpg',
            ...
            [
                'name' => 'Testing',
                'image' => 'images/skills/testing.jpg',
            ...
            [
                'name' => 'Tooling',
                'image' => 'images/skills/tooling.jpg',
