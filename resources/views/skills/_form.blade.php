...
<div class="input-group col-md-12">
    ...
    {{ Form::text('started_at', null, ['class' => 'col-md-8 form-control', 'id' => 'skills_started_at']) }}
</div>
<div class="input-group col-md-12">
...
<div class="input-group col-md-12">
    ...
    {{ Form::text('times_completed', null, ['class' => 'col-md-8 form-control']) }}
</div>
<div class="input-group col-md-12">
    {{ Form::label('completed_at', 'Completed At:', ['class' => 'col-md-4']) }}
    {{ Form::text('completed_at', null, ['class' => 'col-md-8 form-control', 'id' => 'skills_completed_at']) }}
</div>